...
namespace PDVnet.GestaoProdutos.Infrastructure.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        /// <remarks>
        /// Este metodo utiliza o provedor de banco de dados PostgreSQL via Entity Framewrok Core
        ...
        public static void AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            // Isso define como a aplicaçao se conecta ao banco de dados (ex: PostgreSQL)
            // Exemplo: "Host=localhost;Database=ProdutosDb;Username=postgres;Password=secret"
            ...
            // - UseNpgsql(): indica que o EF Core vai usar o PostgreSQL como provedor
            ...
            services.AddDbContext<ProdutosDbContext>(options => options.UseNpgsql(conection));
